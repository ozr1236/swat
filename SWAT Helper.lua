...
if imguicheck and encodingcheck then
	...
	local buttons 						= {fa.ICON_FA_USER_COG..u8' Настройки пользователя',fa.ICON_FA_FILE_ALT..u8' хуй№№№3 слона',fa.ICON_FA_FILE_ALT..u8' хуй слона№2',fa.ICON_FA_KEYBOARD..u8' Горячие клавиши',fa.ICON_FA_PALETTE..u8' Настройки цветов',fa.ICON_FA_BOOK_OPEN..u8' Правила автошколы',fa.ICON_FA_INFO_CIRCLE..u8' Информация о скрипте'}
